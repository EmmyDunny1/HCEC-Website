...
export default function HeroSection() {
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative w-full h-[32rem] mb-10 overflow-hidden">
        {/* Background Image */}
        <div
        ...
        {/* Bottom Text Box */}
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 h-[10rem] w-[25rem] bg-white/50 shadow-md p-3 rounded-md z-10 flex items-center justify-center">
          <p className="text-center font-semibold">For Text</p>
        </div>
      </div>
    </div>
