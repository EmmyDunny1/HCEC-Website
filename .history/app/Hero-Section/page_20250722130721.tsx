  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative w-full h-[25rem] mb-10 overflow-hidden">
        ...
        {/* Bottom Text Box - halfway over the bottom */}
        <div className="absolute left-1/2 bottom-[calc(50%-7.5rem)] transform -translate-x-1/2 h-[15rem] w-[25rem] bg-white/50 shadow-md p-3 rounded-md z-10 flex items-center justify-center">
          <p className="text-center font-semibold">For Text</p>
        </div>
      </div>
    </div>
