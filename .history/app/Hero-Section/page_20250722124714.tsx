...
{/* Top Text Box */}
<div className="bg-white/50 shadow-md p-4 rounded-md h-[15rem] w-[25rem] mb-[-7.5rem] z-10">
...
{/* Bottom Text Box */}
<div className="absolute bottom-[-7.5rem] overflow-hidden left-1/2  transform -translate-x-1/2 h-[15rem] w-[25rem] bg-white/5 shadow-md p-3 rounded-md z-10">
  <p className="text-center font-semibold">For Text</p>
</div>
</div>
</div>
