  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 bg-black/60 min-h-screen">
        ...
        <div className="bg-red-600/95 text-white p-8 flex flex-col justify-center">
        ...
        <div className="bg-white/90 p-8 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <input name="name" value={formData.name} onChange={handleChange} placeholder="Name" className="w-full p-2 border-b-2 border-gray-800 text-white" />
            <input name="email" type="email" value={formData.email} onChange={handleChange} placeholder="Email" className="w-full p-2 border-b-1 border-gray-800 text-white" />
