...
export default function Homepage() {
  return (
    <div className='bg-gradient-to-r from-[#0C101C]  to-red-500 px-10 pt-[5rem]'>
  <div className='text-6xl md:text-9xl text-white font-bold mx-auto leading-[4rem] md:leading-[9rem] mt-5 md:justify-start justify-center'>
  His Coming <br />
  <span className='text-red-500 border-b-white'>Evangelical</span> Church Int&apos;Inc
</div>
