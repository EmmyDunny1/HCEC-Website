  ...
  return (
    <div className='text-white'>
      ...
      <div className='flex flex-col md:flex-row justify-between items-center'>
        {/* Program description */}
        <div className='j p-5 m-5 w-full md:w-1/3'>
          <h2 className='text-6xl font-bold'>Great Annual Convention 2025</h2>
        </div>
        {/* Convention flier */}
        <div className='rounded-lg p-5 m-5 w-full md:w-2/3'>
          <Image
            src={Convention}
            alt="Convention"
            className='w-[15rem] h-[15rem] md:w-[30rem] md:h-[35rem] object-fill rounded-lg'
