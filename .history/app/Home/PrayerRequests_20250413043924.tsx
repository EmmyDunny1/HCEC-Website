...
export default function PrayerRequests() {
  ...
  return (
    <div className="bg-gradient-to-r from-white to-blue-500 p-10 rounded-lg shadow-lg max-w-3xl mx-auto text-black">
      <h2 className="text-3xl font-bold text-center mb-6 text-blue-700">Submit Your Prayer Request</h2>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          type="submit"
          className="w-full bg-blue-700 hover:bg-blue-800 text-white font-bold py-3 rounded-lg transition duration-300"
        >
