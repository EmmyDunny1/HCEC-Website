  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-[#f3f4f6]">
      ...
      <div className="relative w-full md:w-[400px] flex-shrink-0">
        <div className="md:fixed md:top-5 rounded-lg md:right-0 md:h-screen md:bottom- md:w-[400px] flex flex-col items-center justify-center bg-white shadow-lg p-6">
