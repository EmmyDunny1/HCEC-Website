  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-[#f3f4f6]">
      ...
      <div className="relative w-full md:w-[400px] flex-shrink-0">
        <div className="md:fixed md:top-7 rounded-lg md:right-0 md:bottom-7 md:w-[400px] flex flex-col items-center justify-center bg-white shadow-lg p-6">
          <div className="w-full h-[300px] relative mb-4 mt-6 rounded-lg overflow-hidden">
            <Image
              ...
              fill
              style={{ objectFit: "contain", objectPosition: "top", width }}
