...
import Conventionwor from '../assets/worship.jpg'
...
export default function ContactUs() {
  return (
    <div className='text-white px-10 justify-center bg-[#0C101C] p-10 flex flex-col'>
      ...
      <Image src={worship} alt="Your Image" className="w-full h-full object-cover" />
      <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
        <h1 className="text-4xl font-bold">Worship Centers By Regions</h1>
        <p className="text-lg">To Fellowship With Us At any of Our Centers</p>
      </div>
    </div>
