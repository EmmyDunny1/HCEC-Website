...
export default function ContactLinks() {
  ...
  return (
    <nav className="w-full fixed top-0 z-10 shadow-white bg-[#0C101C] h-screen md:bg-[#0C101C]/50 md:h-10 py-4 px-2">
      <div className="flex items-center justify-between mb-2">
        ...
        <a
          ...
          className="text-white hover:text-green-400 flex items-center gap-"
        >
