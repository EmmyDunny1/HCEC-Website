...
export default function ContactLinks() {
  ...
  return (
    <nav className="w-full fixed top-0 z-10 shadow-fuchsia-400 bg-[#0C101C]/20  py-4 px-2 flex justify-center">
          ...
          <li key={item.label}>
            <Link
              ...
              className={`text-white font-semibold px-3 py-2 rounded transition 
                ${pathname === item.link ? "border-b-1 border-red-white text-white shadow" : "hover:bg-red-500/80 hover:text-white"}`}
            >
              {item.label}
            </Link>
          </li>
