...
export default function ContactLinks() {
  ...
  return (
    <nav className="w-full fixed mx-auto justify-center top-0 z-50 bg-[#0C101C] md:bg-[#0C101C]/50 md:h-[6rem] py-4 px-4 shadow-md">
      ...
      <ul
        className={`transition-all duration-300 ease-in-out overflow-hidden flex flex-col md:flex-row md:justify-center gap-2 md:gap-6
