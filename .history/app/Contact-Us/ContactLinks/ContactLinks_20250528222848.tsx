...
export default function ContactLinks() {
  ...
  return (
    <nav className="w-full bg-[#0C101C] border-b-1 border-whshadow-md py-4 px-2 flex justify-center">
          ...
          <li key={item.label}>
            <Link
              ...
              className={`text-white font-semibold px-3 py-2 rounded transition 
                ${pathname === item.link ? "bg-red-500 text-white shadow" : "hover:bg-red-500/80 hover:text-white"}`}
            >
              {item.label}
            </Link>
          </li>
