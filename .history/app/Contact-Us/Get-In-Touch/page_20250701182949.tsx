    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 bg-black/60 min-h-screen">
        ...
        <div className="bg-gray-700 text-white px-10 flex flex-col justify-center">
          ...
          <p className="mb-6">
          Whether you are just paying us a visit for the very first time, or you want to talk to us, or you have a prayer request, or you want to share your testimony, we are here for you. You can now conveniently submit your prayer requests online, by filling the form or through mail, or via a simple phone call. This seamless process ensures that heartfelt intentions reach the dedicated prayer teamg.
          </p>
          <div className="mb-2">
