...
export default function OurLocations() {
  return (
    ...
    <div className='text-white  justify-center bg-[#0C101C] px-10 flex flex-col'>
      ...
      <div className="relative w-full h-[20rem] px overflow-hidden">
      <Image src='/assets/worship.jpg' width={80}
  height={48} alt="Your Image" className="w-full h-full px-0 object-cover blur-[2px]" />
