...
export default function PrayerRequest() {
  ...
  return (
    ...
    <div> </div>
    <div className="grid grid-cols-1 mb-[15rem] md:grid-cols-3 min-h-screen">
      {/* Left Image */}
      <div className="hidden md:block col-span-1 bg-cover bg-center" style={{ backgroundImage: "url('/keyboard-headset.jpg')" }}></div>

      {/* Middle Red Section */}
      <div className="col-span-1 bg-red-600 text-white p-8 flex flex-col justify-center">
      ...
      <div className="col-span-1 bg-gray-100 p-8">
        <h2 className="text-2xl font-bold text-blue-900 mb-4">Drop your Prayer Request</h2>
