...
export default function ContactUs() {
  return (
    <div className='text-white px-10 justify-center bg-[#0C101C] p-10 flex flex-col'>
      ...
      <div className="absolute text-shadow-black shadow-2xl inset-0 flex flex-col justify-center items-center text-white ">
       <div><Image src={HCEC_LOGO} alt='Church logo' className='h-[6rem] w-[10rem]' /> </div>
        ...
        <p className="text-2xl font-light">Our Church Locations in Various Regions are Below</p>
      </div>
    </div>
