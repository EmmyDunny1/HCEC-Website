...
export default function Navbar() {
  return (
    ...
    <div className='fixed justify-between top-0 bg-gradient-to-r from-[#0C101C]  to-red-500  flex max-w-7xl w-full mx-auto  text-white p-4 transition-all border-b-1 rounded-b-4xl  shadow-2xl  hover:border-0 '>
      ...
      <BiMenuAltRight className='text-2xl text-red-500'/>
    </div>
    </div>
  )
}