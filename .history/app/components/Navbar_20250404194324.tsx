...
<section className='flex my-auto transition-all justify-between items-center gap-20'>
    ...
    <nav className='flex my-auto justify-between items-center gap-10'>
        ...
        <div className='flex-col absolute hidden w-auto rounded-lg justify-between top-10 right-0 group-hover:flex  bg-amber-50 text-black border-2 border-gray-200 shadow-lg'>
                   {d.children?.map((ch, i) => (
