...
export default function Navbar() {
  return (
    <div className='flex max-w-7xl w-full mx-auto bg-[#0C101C] text-white p-4 transition-all border-b-1   shadow-2xl shadow-pink-700 backdrop-blur-3xl hover:border- '>
