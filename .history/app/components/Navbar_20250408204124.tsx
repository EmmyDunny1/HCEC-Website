...
export default function Navbar() {
  return (
    ...
    <div className='fixed top-0 flex max-w-7xl w-full mx-auto  text-white p-4 transition-all border-b-1 rounded-b-4xl  shadow-2xl border-gradient-to-r from-red-500 to-[#0C101C] hover:border-0 '>
