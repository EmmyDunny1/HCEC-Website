         ...
         <a href="#"><Image
          ...
          <div>
            ...
            <div className="flex justify-center space-x-4 text-xl">
              ...
              <a href="#" aria-label="Instagram" className="hover:text-pink-400 hover:border-b-2 hover:border-red-400 pb-2"><FaInstagram /></a>
              <a href="#" aria-label="YouTube" className="hover:text-red-500 hover:border-b-2 hover:border-red-400 pb-2"><FaYoutube /></a>
            </div>
          </div>
        </div>
        {/* Copyright */}
