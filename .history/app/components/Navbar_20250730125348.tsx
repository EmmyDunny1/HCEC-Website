...
const defaultNavItems: NavItem[] = [
  ...
  { label: "CONTACT US", link: "/Contact-Us/Home", children: [{label: "Our Locations", link: "" }, {label: "Prayer Request", link:""},{label: "Testimony", link:"/Contact-Us/Testimony"}, {label: "Contact Us", link:"/Contact-Us/Get-In-Touch"}, ]},
];
