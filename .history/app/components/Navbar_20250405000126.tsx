...
<section className='flex my-auto transition-all justify-between items-center gap-20'>
    ...
    <nav className='flex my-auto justify-between items-center gap-10'>
        ...
        <div className='flex-col text-sm px-[2rem] items-center absolute hidden  justify-between top-[5rem] right-0 group-hover:flex  bg-amber-50 text-black w-[10rem] transition-all'>
                   {d.children?.map((ch, i) => (
