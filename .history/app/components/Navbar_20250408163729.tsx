...
export default function Navbar() {
  return (
    ...
    <div className='fixed top-0 flex max-w-7xl w-full mx-auto  text-white p-4 transition-all border-b-1 rounded-b-4xl  shadow-2xl border-red-500  hover:border-0 '>
      <section className='flex transition-all justify-between my-auto gap-[25rem]'>
        ...
        <nav className='text-[10px] hidden md:text-5xl justify-between items-center gap-10'>
          {navItems.map((d, i) => (
