...
export default function Navbar(fine) {
  return (
    <div className='flex max-w-7xl w-full mx-auto text-sm bg-[#0C101C] text-white p-4 transition-all  '>
<section className='flex max-w-7xl transition-all justify-between items-center  gap-20 border-b-1 border-[#CB2629] rounded-2xl'>
   <div> <Image src={HCEC_LOGO} alt="HCEC Logo" className="h-[2.5rem] w-[4rem] object-cover"/></div>
