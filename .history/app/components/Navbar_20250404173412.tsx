...
<section className='flex  transition-all justify-between items-center  gap-20 border-b-1 border-[#CB2629] rounded-2xl'>
   <div></div> <Image src={HCEC_LOGO} alt="HCEC Logo" className="h-[2.5rem] w-[4rem] object-cover"/>
