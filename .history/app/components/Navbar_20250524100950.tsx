...
const navItems: NavItem[] = [
  { label: "HOME", link: "#", children: [{ label: "Upcoming Events", link: "Home-page/Upcoming-Programs" }, { label: "Prayer Requests", link: "Home-page/Prayer-Request" }, { label: "Our Beliefs", link: "#" }] },
  ...
  { label: "CONTACT US", link: "#", children: [{ label: "Contact Form", link: "/Contact-Us" }] },
];
    ...
    <div className="bg-[#0C101C]">
      <div className="fixed top-0 bg-gradient-to-r from-[#0C101C] to-red-500 flex max-w-7xl w-full mx-auto text-white p-4 transition-all border-b-1 rounded-b-4xl shadow-2xl hover:border-0">
        <section className="flex transition-all justify-between my-auto items-center gap-[19.5rem] md:gap-[25rem]">
          <Image src="/assets/HCEC_LOGO.png"  width={80}
  height={48} alt="HCEC Logo" className="h-[3rem] w-[5rem] object-cover" />
