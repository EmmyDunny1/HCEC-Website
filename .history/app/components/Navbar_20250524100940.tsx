...
const navItems: NavItem[] = [
  { label: "HOME", link: "#", children: [{ label: "Upcoming Events", link: "Home-page/Upcoming-Programs" }, { label: "Prayer Requests", link: "Homei/Prayer-Request" }, { label: "Our Beliefs", link: "#" }] },
