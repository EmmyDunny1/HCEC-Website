...
export default function Navbar() {
  return (
    ...
    <div className='fixed top-0 flex max-w-7xl hidde w-full mx-auto  text-white p-4 transition-all border-b-1 rounded-b-4xl  shadow-2xl border-red-500  hover:border-0 '>
