        ...
        <nav className='text-[10px] flex justify-between items-center gap-10'>
          {navItems.map((d, i) => (
            <div key={i} className='group relative'>
              ...
              {/* Dropdown */}
              {d.children && (
                <div className='dropdown cursor-pointer absolute hidden group-hover:flex flex-col px-[2rem] top-10 bg-amber-50 text-black w-[13rem] transition-all text-[12px] border-t-2 border-red-500 out'>
                  {d.children.map((ch, j) => (
