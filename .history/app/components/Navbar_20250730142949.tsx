...
export default function Navbar({
  ...
  return (
    <div className="bg-[#0C101C]">
      <div className="fixed top-0 rounrounded-2xl bg-red-800 flex max-w-7xl w-full mx-auto text-white p-4 transition-all border-b-1  shadow-2xl hover:border-0 z-50" suppressHydrationWarning>
