...
const navItems: NavItem[] = [
  { label: "HOME", link: "#", children: [{ label: "Upcoming Events", link: "Home-page/" }, { label: "Prayer Requests", link: "#" }, { label: "Our Beliefs", link: "#" }] },
  { label: "ABOUT US", link: "#", children: [{ label: "Our History", link: "About-Us/our-history" }, { label: "Mission and Vision", link: "About-Us/mission-and-vision" }, { label: "Our Beliefs", link: "About-Us/our-belie" }] },
