...
<section className='flex my-auto transition-all justify-between items-center gap-20'>
    ...
    <nav className='flex my-auto justify-between items-center gap-10'>
        ...
        <div className='flex-col px-[2rem] items-center absolute hidden  justify-between top-10 right-0 left- group-hover:flex  bg-amber-50 text-black w-[13rem] transition-all text-[12px]'>
                   {d.children?.map((ch, i) => (
