...
export default function Navbar() {
  return (
    <div className='flex max-w-7xl w-full mx-auto bg-[#0C101C] text-white p-4 transition-all border-b-2 border-pink-400 rounded-b-2xl  shadow-2xl shadow-blue-300 backdrop-blur '>
